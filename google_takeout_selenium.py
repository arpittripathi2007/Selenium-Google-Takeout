...
driver = webdriver.Chrome('/home/ahaloans/Documents/AhaLoans/Production/Selenium/DrivingLicenseSarathi/Selenium-Google-Takeout/chromedriver', options = options)
